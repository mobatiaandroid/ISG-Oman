 ...
 */
public class ContactUsActivityOld extends FragmentActivity implements URLConstants, JsonTagConstants, StausCodes, LocationListener, OnMapReadyCallback,
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(ContactUsActivityOld.this, "Contact Us");
      /*if(AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")){
        ...
        showMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (optString.size()>0) {
                    stopDisconnectTimer();
                    Intent intent = new Intent(ContactUsActivityOld.this, FloorPlanActivity.class);
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            System.out.println("Man to ad---" + sectoadmin);
                            mapFragment.getMapAsync((OnMapReadyCallback) mContext);
                            googleApiClient = new GoogleApiClient.Builder(ContactUsActivityOld.this)
                                    .addConnectionCallbacks((GoogleApiClient.ConnectionCallbacks) mContext)
                                    .addOnConnectionFailedListener((GoogleApiClient.OnConnectionFailedListener) ContactUsActivityOld.this)
                                    .addApi(LocationServices.API)
                                    .build();
                        } else {
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(ContactUsActivityOld.this, false);
            AppPreferenceManager.setUserId(ContactUsActivityOld.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(ContactUsActivityOld.this, false);
            AppPreferenceManager.setSchoolSelection(ContactUsActivityOld.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(ContactUsActivityOld.this, LoginActivity.class);
