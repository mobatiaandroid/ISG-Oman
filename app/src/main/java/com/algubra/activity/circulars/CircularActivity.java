package com.algubra.activity.circulars;
 ...
 */
public class CircularActivity extends Activity implements URLConstants,JsonTagConstants,StausCodes {
    RecyclerView messageList;
    RelativeLayout relativeHeader;
    HeaderManager headermanager;
    ImageView back;
    Context mContext = this;
    ArrayList<CircularModel> listTimetable=new ArrayList<>();
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            if (staffArray.length() > 0) {
                                ...
                                for (int i = 0; i < staffArray.length(); i++) {
                                    ...
                                    CircularModel tableModel=new CircularModel();
                                    tableModel.setId(sObject.optString(JTAG_ID));
                                    tableModel.setTitle(sObject.optString(JTAG_NAME));
                                    tableModel.setPdf_link(sObject.optString(JTAG_PDF_LINK));
                                    tableModel.setCircularDate(sObject.optString("published"));
                                ...
                                CircularAdapter timeTableAdapter=new CircularAdapter(mContext,listTimetable);
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(CircularActivity.this, "Circulars");
        if (AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")) {
...
*/
                      System.out.println("PDF_URL: "+listTimetable.get(position).getPdf_link());
