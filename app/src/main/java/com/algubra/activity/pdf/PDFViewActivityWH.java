...
public class PDFViewActivityWH extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
...
//    PDFView pdf;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activty_pdfview_homework);
        mContext = this;
...
//        pdfWebViewClient.loadPdfUrl(url);
        ...
        dialog = new ProgressDialog(PDFViewActivityWH.this);
...
//        });
       ...
       // Pdf.setBackgroundColor(Color.LTGRAY);
        ...
        headermanager = new HeaderManager(PDFViewActivityWH.this, title);
        ...
        print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    ...
                    PrintJob printJob = printManager.print(jobName, new PDFPrintDocumentAdapter(PDFViewActivityWH.this, "document", getFilepath("document.pdf")), null);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopDisconnectTimer();
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    mProgressDialog = new ProgressDialog(PDFViewActivityWH.this);
