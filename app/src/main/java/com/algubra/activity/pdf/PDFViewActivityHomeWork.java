...
import com.algubra.activity.homework.ChooserFileUtils;
import com.algubra.activity.homework.HomeWorkListActivity;
...
public class PDFViewActivityHomeWork extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
...
//    PDFView pdf;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activty_pdfview_wh);
        mContext = this;
...
//        pdfWebViewClient.loadPdfUrl(url);
        ...
        dialog = new ProgressDialog(PDFViewActivityHomeWork.this);
...
//        });
        ...
        headermanager = new HeaderManager(PDFViewActivityHomeWork.this, title);
        ...
        print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    ...
                    PrintJob printJob = printManager.print(jobName, new PDFPrintDocumentAdapter(PDFViewActivityHomeWork.this, "document", getFilepath("document.pdf")), null);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopDisconnectTimer();
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    mProgressDialog = new ProgressDialog(PDFViewActivityHomeWork.this);
                    mProgressDialog.setMessage("Downloading..");
                    mProgressDialog.setIndeterminate(true);
                    mProgressDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
                    mProgressDialog.setCancelable(true);
                    new PDFViewActivityHomeWork.DownloadPDF().execute();
                    mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                        @Override
                        public void onCancel(DialogInterface dialog) {
                            new PDFViewActivityHomeWork.DownloadPDF().cancel(true); //cancel the task
                        }
                    });
                } else {
                    AppUtilityMethods.showDialogAlertDismiss((Activity) mContext, "Network Error", getString(R.string.no_internet), R.drawable.nonetworkicon, R.drawable.roundred);
        ...
        PermissionListener permissionListenerGallery = new PermissionListener() {
            ...
            public void onPermissionGranted() {
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    ...
                    new PDFViewActivityHomeWork.loadPDF().execute();
                } else {
                    AppUtilityMethods.showDialogAlertDismiss((Activity) mContext, "Network Error", getString(R.string.no_internet), R.drawable.nonetworkicon, R.drawable.roundred);
                }
