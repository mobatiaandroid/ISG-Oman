...
public class PDFTest extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
...
//        pdfWebViewClient.loadPdfUrl(url);
        ...
        file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/download/" + "document.pdf");
        if (file.exists()) {
            file.delete();
            // Toast.makeText(mContext, "file present", Toast.LENGTH_SHORT).show();
        }

        dialog = new ProgressDialog(PDFTest.this);
...
//        });
        ...
        headermanager = new HeaderManager(PDFTest.this, title);
        ...
        print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    ...
                    PrintJob printJob = printManager.print(jobName, new PDFPrintDocumentAdapter(PDFTest.this, "document", getFilepath("document.pdf")), null);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppUtilityMethods.isNetworkConnected(mContext)) {
                    mProgressDialog = new ProgressDialog(PDFTest.this);
