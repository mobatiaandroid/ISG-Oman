 ...
 */
public class OpenYouTubePlayerActivity extends YouTubeBaseActivity implements
    ...
    Bundle extras;
    int position;
    ArrayList<NotificationModel> videolist = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            videolist = (ArrayList<NotificationModel>) extras
     ...
     * @param wasRestored Depicts whether the video is restored from a previous state.
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) {
            ...
            player.cueVideo(getYoutubeVideoId(videolist.get(position).getUrl()));
