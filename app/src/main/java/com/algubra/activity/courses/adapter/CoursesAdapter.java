package com.algubra.activity.courses.adapter;
...
public class CoursesAdapter extends RecyclerView.Adapter<CoursesAdapter.MyViewHolder> {
    ...
    private ArrayList<CoursesModel> mCoursesList;
    String dept;
    ...
    public CoursesAdapter(Context mContext, ArrayList<CoursesModel> courseList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mTitleTxt.setText(mCoursesList.get(position).getCourseName());
    }
