 ...
 */
public class ClubListActivity extends Activity implements JsonTagConstants,URLConstants,StausCodes{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppUtilityMethods.isNetworkConnected(mContext)) {
            calClubListAPI(URL_GET_CLUB_LIST);
        }else{
    ...
    private void initUI() {
        ...
        eventsList = (RecyclerView) findViewById(R.id.mClubListView);
        ...
        headermanager = new HeaderManager(ClubListActivity.this, "Sports & Activities");//Club
        ...
        eventsList.addOnItemTouchListener(new RecyclerItemListener(getApplicationContext(), eventsList,
                new RecyclerItemListener.RecyclerTouchListener() {
                    public void onClickItem(View v, int position) {
                        ...
                        intent.putExtra("array", clubModelsArrayList);
    ...
    private void calClubListAPI(final String urlGetEventsList) {
            ...
            public void responseSuccess(String successResponse) {
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            if (staffArray.length() > 0) {
                                ...
                                for (int i = 0; i < staffArray.length(); i++) {
                                    ...
                                    ClubModels clubModels = new ClubModels();
                                    clubModels.setClub_id(sObject.optString(JTAG_ID));
                                    clubModels.setClub_name(sObject.optString(JTAG_NAME));
                                    clubModels.setClub_description(sObject.optString(JTAG_DESCRIPTION));
                                    clubModels.setClub_cordinator(sObject.optString(JTAG_CLUB_COORDINATOR));
                                    clubModels.setClub_student_id(sObject.optString(JTAG_STUDENT_ID));
                                    clubModels.setImage(sObject.optString(JTAG_IMAGE));
                                    clubModels.setPdf(sObject.optString(JTAG_REG_FORM));
                                    clubModelsArrayList.add(clubModels);
                                }
                                ClubListAdapter clubListAdapter = new ClubListAdapter(mContext, clubModelsArrayList);
                                eventsList.setAdapter(clubListAdapter);
                                ...
                                AppUtilityMethods.showDialogAlertDismiss((Activity) mContext, getString(R.string.alert_heading), getString(R.string.no_clubfound), R.drawable.infoicon,  R.drawable.roundblue);
                        ...
                        calClubListAPI(urlGetEventsList);
                    } else {
    ...
    protected void onRestart() {
        ...
        if (AppPreferenceManager.getUserId(mContext).equalsIgnoreCase("")) {
            Intent mIntent = new Intent(ClubListActivity.this, LoginActivity.class);
            mIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(mIntent);
            finish();
        }
        else {
            clubModelsArrayList.clear();
            if (AppUtilityMethods.isNetworkConnected(mContext)) {
                calClubListAPI(URL_GET_CLUB_LIST);
            } else {
                AppUtilityMethods.showDialogAlertDismiss((Activity) mContext, "Network Error", getString(R.string.no_internet), R.drawable.nonetworkicon, R.drawable.roundred);
   ...
   /* public static final long DISCONNECT_TIMEOUT = 300000;; // 5 min = 5 * 60 * 1000 ms
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(ClubListActivity.this, false);
            AppPreferenceManager.setUserId(ClubListActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(ClubListActivity.this, false);
            AppPreferenceManager.setSchoolSelection(ClubListActivity.this, "ISG");
