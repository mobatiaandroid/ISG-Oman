...
import com.algubra.activity.quotesandstories.adapter.QuotesandStoryAdapter;
 ...
 */
public class QuotesandStoriesActivity extends Activity implements JsonTagConstants,StausCodes,URLConstants{
    ...
    String quote,story_title,story_full;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppUtilityMethods.isNetworkConnected(mContext)){
            getTimeTableList(URL_GETQUOTES);
        }else{
    ...
    private void initUI() {
        ...
        QuotesandStoryModel model = new QuotesandStoryModel();
//        model.setItemName("Today's Quote");
        model.setItemName("Weekly Quote");

        listQuotes.add(model);
        QuotesandStoryModel model1 = new QuotesandStoryModel();
//        model1.setItemName("Today's Story");
        model1.setItemName("Weekly Story");

        listQuotes.add(model1);
        ...
        headermanager = new HeaderManager(QuotesandStoriesActivity.this, "Quotes & Stories");
        ...
        QuotesandStoryAdapter adapter = new QuotesandStoryAdapter(mContext, listQuotes);
                ...
                new RecyclerItemListener.RecyclerTouchListener() {
                    public void onClickItem(View v, int position) {
                        ...
                        if(position==0) {
                            ...
                            Intent intent = new Intent(QuotesandStoriesActivity.this, QuotesDetailActivity.class);
                            intent.putExtra("quote",quote);
                            startActivity(intent);
                        }else{
                            Intent intent = new Intent(QuotesandStoriesActivity.this, StroryDetailActivity.class);
                            intent.putExtra("story",story_full);
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            JSONArray staffArray = secobj.getJSONArray(JTAG_QUOTES);
                            System.out.println("The response is" + staffArray);

                            if (staffArray.length() > 0) {
                                quote = staffArray.getJSONObject(0).getString(JTAG_QUOTE);
                            } else {
                            ...
                            JSONArray storyArra = secobj.getJSONArray(JTAG_STORY);
                            if (storyArra.length() > 0) {
                                story_title = storyArra.getJSONObject(0).getString(JTAG_TITLE);
                                story_full = storyArra.getJSONObject(0).getString(JTAG_STORY);
   ...
   /* public static final long DISCONNECT_TIMEOUT = 300000;; // 5 min = 5 * 60 * 1000 ms
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(QuotesandStoriesActivity.this, false);
            AppPreferenceManager.setUserId(QuotesandStoriesActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(QuotesandStoriesActivity.this, false);
            AppPreferenceManager.setSchoolSelection(QuotesandStoriesActivity.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(QuotesandStoriesActivity.this, LoginActivity.class);
