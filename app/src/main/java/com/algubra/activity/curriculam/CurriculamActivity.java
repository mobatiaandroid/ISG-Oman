package com.algubra.activity.curriculam;
 ...
 */
public class CurriculamActivity extends Activity implements URLConstants,JsonTagConstants,StausCodes {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppUtilityMethods.isNetworkConnected(mContext)) {
            getTimeTableList(URL_GET_STUDYPLANANDCURRICULAM);
        }else{
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            JSONArray staffArray = secobj.getJSONArray(JTAG_CURRICULAM);
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(CurriculamActivity.this, "Syllabus & Affiliation");//"Study & Curriculum");
        if (AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")) {
...
//                        stopDisconnectTimer();
                  /*      Intent intent = new Intent(CurriculamActivity.this, PdfReader.class);
                        ...
                        if (!(listTimetable.get(position).getPdf_link().equalsIgnoreCase(""))) {
                            Intent browserIntent = new Intent(CurriculamActivity.this, PDFViewActivity.class);
                            browserIntent.putExtra("pdf_url",listTimetable.get(position).getPdf_link());
                            browserIntent.putExtra("title","Curriculam");
  ...
  /*  public static final long DISCONNECT_TIMEOUT = 300000;; // 5 min = 5 * 60 * 1000 ms
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(CurriculamActivity.this, false);
            AppPreferenceManager.setUserId(CurriculamActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(CurriculamActivity.this, false);
            AppPreferenceManager.setSchoolSelection(CurriculamActivity.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(CurriculamActivity.this, LoginActivity.class);
