package com.algubra.activity.timetable.adapter;
...
public class TimeTableAdapter  extends RecyclerView.Adapter<TimeTableAdapter.MyViewHolder> {
    ...
    private ArrayList<TimeTableModel> mTimeTableList;
    String dept;
    ...
    public TimeTableAdapter(Context mContext,ArrayList<TimeTableModel> timeTableList) {
