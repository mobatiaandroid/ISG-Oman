package com.algubra.activity.studentleaders;
...
import com.algubra.activity.studentleaders.adapter.StudentLeadersListAdapter;
 ...
 */
public class StudentLeadersListActivity extends Activity implements URLConstants,JsonTagConstants,StausCodes {
    RecyclerView messageList;
    RelativeLayout relativeHeader;
    HeaderManager headermanager;
    ImageView back;
    Context mContext = this;
    ArrayList<StudentLeadersModel> listTimetable=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppUtilityMethods.isNetworkConnected(mContext)) {
            getTimeTableList(URL_GET_STUDENT_LEADERS);
        }else{
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            JSONArray staffArray = secobj.getJSONArray(JTAG_STUD_LEADERS);
                            ...
                            if (staffArray.length() > 0) {
                                ...
                                for (int i = 0; i < staffArray.length(); i++) {
                                    ...
                                    StudentLeadersModel studentAwardModel = new StudentLeadersModel();
                                    studentAwardModel.setId(sObject.optString(JTAG_ID));
                                    studentAwardModel.setTitle(sObject.optString(JTAG_TITLE));
                                    studentAwardModel.setDescription(sObject.optString(JTAG_DESCRIPTION));
                                    studentAwardModel.setPdf_link(sObject.optString(JTAG_IMAGE));
                                    listTimetable.add(studentAwardModel);
                                    /*"id": "2",
        "boardid": "1",
        "title": "Student Leader 2017",
        "description": "The University of Leicester Student Awards 2017 celebrates individual students and student groups' fantastic achievements for the year, with this year's awards ceremony taking place on Wednesday 7th June 2017.",
        "image": "http:\/\/mobicare2.mobatia.com\/algubra\/media\/uploads\/sl_59eee9b29aada.pdf",
        "board": "ISG"*/
                                }
                                ...
                                StudentLeadersListAdapter timeTableAdapter = new StudentLeadersListAdapter(mContext, listTimetable);
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(StudentLeadersListActivity.this, "Student Leaders");
        if (AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")) {
...
//                            stopDisconnectTimer();
                         /*   Intent intent = new Intent(StudentLeadersListActivity.this, PdfReader.class);
                            intent.putExtra("pdf_url",listTimetable.get(position).getPdf_link());
                            startActivity(intent);*/
                            if (!(listTimetable.get(position).getPdf_link().equalsIgnoreCase(""))) {
                                Intent browserIntent = new Intent(StudentLeadersListActivity.this, PDFViewActivity.class);
                                browserIntent.putExtra("pdf_url",listTimetable.get(position).getPdf_link());
                                browserIntent.putExtra("title","Student Leaders");
                           ...
                           /* Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(listTimetable.get(position).getPdf_link()));
                            startActivity(browserIntent);*/
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(StudentLeadersListActivity.this, false);
            AppPreferenceManager.setUserId(StudentLeadersListActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(StudentLeadersListActivity.this, false);
            AppPreferenceManager.setSchoolSelection(StudentLeadersListActivity.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(StudentLeadersListActivity.this, LoginActivity.class);
