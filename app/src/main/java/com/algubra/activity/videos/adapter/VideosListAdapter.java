package com.algubra.activity.videos.adapter;
...
public class VideosListAdapter extends RecyclerView.Adapter<VideosListAdapter.MyViewHolder> {
    ...
    private ArrayList<VideosModel> mTimeTableList;
    String dept;
    ...
    public VideosListAdapter(Context mContext, ArrayList<VideosModel> timeTableList) {
