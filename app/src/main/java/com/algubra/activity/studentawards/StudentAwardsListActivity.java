package com.algubra.activity.studentawards;
...
import com.algubra.activity.studentawards.adapter.StudentAwardsListAdapter;
import com.algubra.activity.studentawards.model.StudentAwardModel;
 ...
 */
public class StudentAwardsListActivity extends Activity implements URLConstants,JsonTagConstants,StausCodes {
    RecyclerView messageList;
    RelativeLayout relativeHeader;
    HeaderManager headermanager;
    ImageView back;
    Context mContext = this;
    ArrayList<StudentAwardModel> listTimetable=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(AppUtilityMethods.isNetworkConnected(mContext)) {
            getTimeTableList(URL_GET_STUDENT_AWARDS);
        }else{
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            JSONArray staffArray = secobj.getJSONArray(JTAG_STUD_AWARDS);
                            listTimetable.clear();
                            if (staffArray.length() > 0) {
                                ...
                                for (int i = 0; i < staffArray.length(); i++) {
                                    ...
                                    studentAwardModel.setSubject(sObject.optString(JTAG_NAME));
                                    studentAwardModel.setPdf_link(sObject.optString(JTAG_PDF_LINK));
                                ...
                                StudentAwardsListAdapter timeTableAdapter = new StudentAwardsListAdapter(mContext, listTimetable);
    ...
    private void initUI() {
        ...
        messageList = findViewById(R.id.settingItemList);
        ...
        headermanager = new HeaderManager(StudentAwardsListActivity.this, "Competition Results");
        if (AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")) {
                ...
                new RecyclerItemListener.RecyclerTouchListener() {
                    public void onClickItem(View v, int position) {
                        if (!(listTimetable.get(position).getPdf_link().equalsIgnoreCase(""))) {
                            Intent browserIntent = new Intent(StudentAwardsListActivity.this, PDFViewActivity.class);
                            browserIntent.putExtra("pdf_url",listTimetable.get(position).getPdf_link());
                            browserIntent.putExtra("title","Student Awards");
                            browserIntent.putExtra("filename",listTimetable.get(position).getSubject());
   ...
   /* public static final long DISCONNECT_TIMEOUT = 300000;; // 5 min = 5 * 60 * 1000 ms
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(StudentAwardsListActivity.this, false);
            AppPreferenceManager.setUserId(StudentAwardsListActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(StudentAwardsListActivity.this, false);
            AppPreferenceManager.setSchoolSelection(StudentAwardsListActivity.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(StudentAwardsListActivity.this, LoginActivity.class);
