package com.algubra.activity.studentawards.adapter;
 ...
 */
public class StudentAwardsListAdapter extends RecyclerView.Adapter<StudentAwardsListAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<StudentAwardModel> mTimeTableList;
    String dept;
    ...
    public StudentAwardsListAdapter(Context mContext,ArrayList<StudentAwardModel> timeTableList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mTitleTxt.setText(mTimeTableList.get(position).getSubject());
    }
