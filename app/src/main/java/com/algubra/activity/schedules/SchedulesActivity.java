package com.algubra.activity.schedules;
 ...
 */
public class SchedulesActivity extends Activity implements URLConstants, JsonTagConstants, StausCodes {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppUtilityMethods.isNetworkConnected(mContext)) {
            getTimeTableList(URL_GET_SCHEDULES);
        } else {
                ...
                try {
                    ...
                    if (response_code.equalsIgnoreCase(RESPONSE_SUCCESS)) {
                        ...
                        if (status_code.equalsIgnoreCase(STATUSCODE_SUCCESS)) {
                            ...
                            JSONArray staffArray = secobj.getJSONArray(JTAG_SCHEDULES);
    ...
    private void initUI() {
        ...
        headermanager = new HeaderManager(SchedulesActivity.this, "Exam Schedule");
        if (AppPreferenceManager.getSchoolSelection(mContext).equals("ISG")) {
...
//                        stopDisconnectTimer();
                       ...
                       /* Intent intent = new Intent(SchedulesActivity.this, PdfReader.class);
...
//                        startActivity(browserIntent);
                        if (!(listTimetable.get(position).getPdf_link().equalsIgnoreCase(""))) {
                            Intent browserIntent = new Intent(SchedulesActivity.this, PDFViewActivity.class);
                            browserIntent.putExtra("pdf_url",listTimetable.get(position).getPdf_link());
                            browserIntent.putExtra("title","Schedules");
   ...
   /* public static final long DISCONNECT_TIMEOUT = 300000;; // 5 min = 5 * 60 * 1000 ms
    ...
    private Runnable disconnectCallback = new Runnable() {
        ...
        public void run() {
            ...
            AppPreferenceManager.setIsGuest(SchedulesActivity.this, false);
            AppPreferenceManager.setUserId(SchedulesActivity.this, "");
            AppPreferenceManager.setIsUserAlreadyLoggedIn(SchedulesActivity.this, false);
            AppPreferenceManager.setSchoolSelection(SchedulesActivity.this, "ISG");
            if (AppUtilityMethods.isAppInForeground(mContext)) {

                Intent mIntent = new Intent(SchedulesActivity.this, LoginActivity.class);
