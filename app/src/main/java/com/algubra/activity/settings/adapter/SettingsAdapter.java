package com.algubra.activity.settings.adapter;
...
public class SettingsAdapter extends RecyclerView.Adapter<SettingsAdapter.MyViewHolder> {
    ...
    public SettingsAdapter(Context mContext,ArrayList<String> mSettingsList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mTitleTxt.setText(mSettingsList.get(position));
    }
